...
node_group_templates = [
  {
    ...
    instance_types = ["Standard_D4pls_v5"] # virtual machine instance type which should be used for the worker node groups
  ...
  },
  {
    ...
    desired_size  = 2                   # desired size of this node group; will default to min_size if set to 0
    disk_size     = 64                  # size of attached root volume in GB
    instance_types = ["Standard_D8pls_v5"] # virtual machine instance type which should be used for the worker node groups
    cpu_architecture   = "ARM_64"
  }
]
